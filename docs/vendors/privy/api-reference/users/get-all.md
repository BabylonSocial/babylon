...
Learn more about querying users using our SDKs [here](/user-management/users/managing-users/querying-users).
  ...
  /v1/users:
    get:
      tags:
        - Users
      summary: Gets Users
      description: Get all users in your app.
      parameters:
        - schema:
            type: string
            minLength: 1
      ...
      responses:
        '200':
          description: Requested user objects with pagination.
          content:
            application/json:
              schema:
                type: object
