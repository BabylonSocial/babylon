...
Learn more about pregenerating wallets using our SDKs [here](/recipes/pregenerate-wallets).


## OpenAPI

````yaml post /v1/users/{user_id}/wallets
openapi: 3.1.0
info:
  version: 0.0.1
  title: Privy API
...
paths:
  /v1/users/{user_id}/wallets:
    post:
      tags:
        - Users
      summary: Create Embedded Wallet
      description: Creates an embedded wallet for an existing user.
      parameters:
        - schema:
            type: string
