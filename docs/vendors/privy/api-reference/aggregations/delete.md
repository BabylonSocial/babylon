...
````yaml delete /v1/aggregations/{aggregation_id}
openapi: 3.1.0
info:
  version: 0.0.1
  title: Privy API
...
paths:
  /v1/aggregations/{aggregation_id}:
    delete:
      ...
      description: Delete an aggregation by aggregation ID.
            ...
            application/json:
              schema:
                ...
                properties:
                  success:
                    type: boolean
                    description: Success response indicating the aggregation was deleted.
                required:
                  - success
              example:
                success: true
